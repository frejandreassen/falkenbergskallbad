...
import { getUserCoupons, checkMembership, createBooking, bookUsingCard } from '@/lib/actions';
    ...
    <div className="space-y-6">
      ...
      {order.paymentMethod === 'swish' && (
        <div className="mt-6 p-4 bg-gray-100 rounded-md relative">
          ...
          <h4 className="font-medium mb-2">Swish-betalning</h4>
          <p className="text-gray-700">Skanna QR-koden eller använd telefonnumret 123 456 7890</p>
        </div>
      )}
      {order.paymentMethod === 'card' && (
        <div className="mt-6 p-4 bg-gray-100 rounded-md relative">
