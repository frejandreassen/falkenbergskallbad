...
export default async function Page() {
  ...
  return (
    <div className="bg-white">
      ...
      {(startPage.include_blog) ? <Blog articles={articles.filter(a => a.status === 'published')} header={startPage.blog_header} content={startPage.blog_content} category={startPage.blog_category}/> : null }
